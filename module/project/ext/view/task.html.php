...
<div id="mainMenu" class="clearfix">
  ...
  <div class="btn-toolbar pull-left">
    ...
    foreach(customModel::getFeatureMenu('project', 'task') as $menuItem)
    {
        ...
        elseif($menuType == 'status')
        {
            ...
            {
                if($key == '' || $key == 'needconfirm') continue;
  ...
  <div class="btn-toolbar pull-right">
    ...
    $link = $this->createLink('task', 'bulkcreate', "project=$projectID");

    if(common::hasPriv('task', 'bulkcreate', $checkObject)) echo html::a($link, "<i class='icon icon-plus'></i> {$lang->task->bulkcreate}", '', "class='btn btn-secondary'");
