    ...
    <form class='load-indicator main-form form-ajax' method='post' target='hiddenwin' id='dataform'>
      <table class='table table-form'>
        ...
        <tr>
          ...
          <td><?php echo html::input('code', $project->code, "class='form-control' autocomplete='off' required readonly='readonly'");?></td>
        </tr>
        <tr>
        ...
        <?php endif;?>
        <tr <?php if($config->global->flow == 'onlyTask') echo "class='hidden'";?> class="hide">
