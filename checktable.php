...
include 'http://localhost/PDS/config/config.php';
...
include "http://localhost/PDS/module/misc/lang/{$clientLang}.php";
if($status == 'createFile')
{
    $lang->user = new stdclass();
    $lang->projectCommon = '';
    include "http://localhost/PDS/module/user/lang/{$clientLang}.php";
}
else
{
